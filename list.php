...
$query_usuarios = "SELECT id, nome, cpf FROM usuarios ORDER BY id DESC LIMIT $inicio, $qnt_result_pg";
...
while($row_usuario = $result_usuarios->fetch(PDO::FETCH_ASSOC)){
    ...
    $dados .= "<tr>
                    ...
                    <td>$nome</td>
                    <td>$cpf</td>
                    <td><button id='$id' class='btn btn-warning' onclick='editUsuarioDados($id)'>Editar</button>
                    <button id='$id' class='btn btn-danger' onclick='apagarUsuarioDados($id)'>Apagar</button>
                    </td>
                </tr>";
}
$dados .="</tbody>
